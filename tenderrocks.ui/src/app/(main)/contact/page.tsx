          ...
          <div className="space-y-6">
            ...
            <div className="card p-6">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/tenderrocks_solutions/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-tr-primary dark:text-gray-400">

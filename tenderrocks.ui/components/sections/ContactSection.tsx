      ...
      <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
        <div className="lg:w-1/2">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-tender-light/10 dark:bg-gray-800 rounded-lg">
            ...
            <div className="p-6 bg-tender-light/10 dark:bg-gray-800 rounded-lg">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-tender-dark dark:text-tender-light hover:text-tender-light dark:hover:text-white">
        ...
        <div className="lg:w-1/2">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <form className="space-y-6">
              ...
              <TextAreaField label="Your Message" />
              
              <button 
                type="submit" 
                className="w-full bg-tender-dark text-white py-3 rounded-lg hover:bg-tender-light transition flex items-center justify-center"
              >
            ...
            <div className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-3">
                ...
                <ContactItem label="Address" value="Lagos, Nigeria" />
              </div>
            </div>
          </div>
        </div>
